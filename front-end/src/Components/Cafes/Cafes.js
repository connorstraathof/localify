					...
					return (
						<div className="blog-post" data-wio-id={cafe.id} key={cafe.id} >
							<h2>
								...
								<a href={this.props.prismicCtx.linkResolver(cafe)}>
									{cafe.data.title.length !== 0 ? RichText.render(cafe.data.title, this.props.prismicCtx.linkResolver) : defaultTitle}
								</a>
							</h2>
