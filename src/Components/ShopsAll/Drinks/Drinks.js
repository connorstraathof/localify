...
export default class Foods extends React.Component {
  ...
  shopHead() {
    ...
    const avatar = { backgroundImage: 'url(localify-drinks.jpg)' }
    return (
      <div className='drinks__blog-head-home'>
        <div className='drinks__avatar-container'>
        <div className='drinks__blog-head__avatar' style={avatar} />
        </div>
