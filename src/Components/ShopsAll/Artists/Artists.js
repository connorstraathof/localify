...
export default class Foods extends React.Component {
  ...
  fetchPage(props) {
    ...
    return props.prismicCtx.api.getSingle('artist_home').then(doc => {
      if (doc) {
        ...
        props.prismicCtx.api
          .query(
            ...
            Prismic.Predicates.at('document.type', 'artist_post'),
  ...
  shopHead() {
    const avatar = { backgroundImage: 'url(localify-artist.jpg)' }
    return (
      <div className='artist__blog-head-home'>
        <div className='artist__avatar-container'>
        <div className='artist__blog-head__avatar' style={avatar} />
        </div>
